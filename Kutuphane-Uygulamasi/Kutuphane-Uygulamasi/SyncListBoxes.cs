...
{
    //Bu sınıfı kod yapısını bozmamak için dışa aldım. Kodun amacı Listbox'ta fazla item olursa iki Listbox'un senkronize kaydırılmasını sağlamaktır. (Ben yazmadım)
